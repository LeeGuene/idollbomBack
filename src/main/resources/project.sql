...
VALUES(SEQ_PROJECT.nextval, 'tlsdlrms12@naver.com', '1234', '강감찬', '강가', '010-3235-3421', '서울시 강남구 서초동', 'pro_logo.png', '14', '영어 강사');
...
INSERT INTO CLASS
(CLASS_NUMBER, CLASS_NAME, CLASS_CATEGORY_BIG, CLASS_CATEGORY_SMALL, CLASS_CONTENT, CLASS_PAYMENT_ACCOUNT, CLASS_REGISTER_DATE, PRO_NUMBER)
VALUES(SEQ_PROJECT.nextval, '영어회화', '교육', '영어', '이근과 함께하는 영어회화 교실!!', 25000, TO_DATE('2024-05-24'), 4);

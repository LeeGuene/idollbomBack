...
CREATE TABLE PARENT_FILE(
    ...
    PARENT_FILE_NAME VARCHAR2(1000) NOT NULL,			-- 첨부파일 이름
...
ALTER TABLE PARENT_FILE MODIFY(PARENT_FILE_NAME VARCHAR2(1000));
ALTER TABLE PARENT_FILE RENAME COLUMN PARENT_FILE_URL TO PARENT_FILE_ORIGIN_NAME;
...
ALTER TABLE RESERVATION_TIME ADD RESERVATION_STATUS NUMBER DEFAULT 0;

ALTER TABLE PARENT_NOTE MODIFY PARENT_NOTE_ALARM_CHECK VARCHAR2(100) DEFAULT '미확인';

ALTER TABLE PRO ADD PRO_REPORT_COUNT NUMBER DEFAULT 0;
ALTER TABLE PRO_POST ADD PRO_POST_REPORTCOUNT NUMBER DEFAULT 0;
ALTER TABLE PRO_FILE RENAME COLUMN PRO_FILE_URL TO PRO_FILE_ORIGIN_NAME;
ALTER TABLE PRO_FILE MODIFY PRO_FILE_ORIGIN_NAME VARCHAR2(1000);
ALTER TABLE PRO_FILE MODIFY PRO_FILE_NAME VARCHAR2(1000);

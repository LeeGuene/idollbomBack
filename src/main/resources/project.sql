...
-- 특정 전문가의 특정 수업의 전체 리뷰 조회
SELECT P.PARENT_NAME, LIST.*
FROM (
    SELECT
        r.REVIEW_NUMBER,
        r.REVIEW_CONTENT,
...
INSERT INTO PARENT
(PARENT_NUMBER, PARENT_EMAIL, PARENT_PASSWORD, PARENT_NAME, PARENT_NICKNAME, PARENT_PHONE_NUMBER, PARENT_ADDRESS, PARENT_PROFILE_IMAGE_URL, PARENT_REPORT_COUNT)
VALUES(SEQ_PROJECT.nextval, 'tlsdlrms3455@naver.com', '1234', '이순신', '장군', '010-3678-1363', '경기도 안성시', 'my_profile.png', 1);

INSERT INTO REVIEW
(REVIEW_NUMBER, REVIEW_CONTENT, REVIEW_EVALUTION_POINT, REVIEW_REGISTER_DATE, REVIEW_UPDATE_DATE, PARENT_NUMBER, CLASS_NUMBER)
VALUES(SEQ_PROJECT.NEXTVAL, '수업 내용은 지루했지만, 강사님의 활기찬 목소리 덕택에 수업은 지루하지 않았다.', 3, SYSDATE, SYSDATE, 11, 7);

INSERT INTO PARENT
(PARENT_NUMBER, PARENT_EMAIL, PARENT_PASSWORD, PARENT_NAME, PARENT_NICKNAME, PARENT_PHONE_NUMBER, PARENT_ADDRESS, PARENT_PROFILE_IMAGE_URL, PARENT_REPORT_COUNT)
VALUES(SEQ_PROJECT.NEXTVAL, 'tlsldmrs123@naver.com', '1234', '홍길동', '홍스', '010-2354-2356', '서울시 강동구 하남시', 'logds.png', 1);
...
-- 위에서 만든 쿼리를 서브 쿼리로 해서, 전문가 테이블과 조인
SELECT *
from (
    SELECT *
    FROM CLASS C JOIN REVIEW R

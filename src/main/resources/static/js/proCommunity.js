...
function getList(page){
    $.ajax({
        ...
        success: function (data){
            // 리스트 뿌려주는 함수
            proRenderBoard(data.content)
            proRenderPagination(data)
...
function proRenderBoard(pros){
    ...
    pros.forEach(function (pro){
        ...
        <tr>
            ...
            <td><input type="hidden" value="${pro.proPostReportCount}"></td>
        </tr>
        `
...
function proRenderPagination(pagination) {
